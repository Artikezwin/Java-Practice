...
public class StartProgramm {
    public static void main(String[] args) {
        ...
        orderManager.addMenu(new Drink(1900, "Что-то из индейки"), "Верхние поля");
        orderManager.addMenu(new Drink(1500, "Пирожные с заварным кремом"), "Римская улица");
        orderManager.addMenu(new Drink(26000, "Набор из 2кг самых вкусных суши"), "Площадь Ильича");
